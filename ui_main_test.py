...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # --- CẤU HÌNH MÀU SẮC CHỦ ĐẠO (GAMING THEME) ---
        ...
        # Nút 2: Quản lý Máy (Machines)
        self.btn_save = QPushButton(self.frame_menus)
        self.btn_save.setObjectName(u"btn_machines") # Renamed
        ...
        # Nút 3: Dịch vụ (Service)
        self.btn_new = QPushButton(self.frame_menus)
        self.btn_new.setObjectName(u"btn_services")
        ...
        self.btn_new.setStyleSheet(u"QPushButton {      \n"
            "      background-image: url(:/16x16/icons/16x16/cil-cart.png);\n" # Icon giỏ hàng
            "      background-position: left center;\n"
            "      background-repeat: no-repeat;\n"
            "      border: none;\n"
            "      border-left: 28px solid rgb(27, 29, 35);\n"
        ...
        # Nút 4: Hội viên (Members)
        self.btn_new_user = QPushButton(self.frame_menus)
        self.btn_new_user.setObjectName(u"btn_members")
        ...
        # Page 1: Home (Dashboard) - Đã sửa lại để chứa Grid Máy trạm
        ...
        self.groupBox.setTitle("Cấu hình Máy Chủ")
        self.groupBox.setStyleSheet("QGroupBox { color: white; font-weight: bold; border: 1px solid gray; margin-top: 10px; } QGroupBox::title { subcontrol-origin: margin; left: 10px; padding: 0 3px; }")
        
        self.layout_groupbox = QVBoxLayout(self.groupBox)
        
        self.label = QLabel("Địa chỉ IP Server:", self.groupBox)
        self.plainTextEdit = QPlainTextEdit(self.groupBox)
        self.plainTextEdit.setMaximumHeight(30)
        self.plainTextEdit.setStyleSheet("background-color: #333; color: white;")
        
        self.label_2 = QLabel("Cổng kết nối (Port):", self.groupBox)
        self.plainTextEdit_2 = QPlainTextEdit(self.groupBox)
        self.plainTextEdit_2.setMaximumHeight(30)
        self.plainTextEdit_2.setStyleSheet("background-color: #333; color: white;")
        
        self.pushButton = QPushButton("Lưu cấu hình", self.groupBox)
        self.pushButton.setMinimumHeight(40)
        self.pushButton.setStyleSheet("background-color: #0078d4; color: white; border-radius: 5px;")
        
        self.layout_groupbox.addWidget(self.label)
        self.layout_groupbox.addWidget(self.plainTextEdit)
        self.layout_groupbox.addWidget(self.label_2)
        self.layout_groupbox.addWidget(self.plainTextEdit_2)
        self.layout_groupbox.addSpacing(20)
        self.layout_groupbox.addWidget(self.pushButton)
        self.layout_groupbox.addStretch()

        self.verticalLayout_settings.addWidget(self.groupBox)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Net Cafe Manager", None))
        self.btn_toggle_menu.setText("")
        self.label_title_bar_top.setText(QCoreApplication.translate("MainWindow", u"Cyber Cafe Manager - Admin Panel", None))
        ...
        self.label_top_info_1.setText(QCoreApplication.translate("MainWindow", u"Trạng thái: Server Online", None))
        self.label_top_info_2.setText(QCoreApplication.translate("MainWindow", u"| DASHBOARD", None))
        
        # --- VIỆT HÓA MENU ---
        self.btn_open_file.setText(QCoreApplication.translate("MainWindow", u"Tổng quan", None)) # Home
        self.btn_save.setText(QCoreApplication.translate("MainWindow", u"Máy trạm", None))    # Machines
        self.btn_new.setText(QCoreApplication.translate("MainWindow", u"Dịch vụ (F&B)", None)) # Services
        self.btn_new_user.setText(QCoreApplication.translate("MainWindow", u"Hội viên", None))  # Members
        self.label_user_icon.setText(QCoreApplication.translate("MainWindow", u"Admin", None))
        self.btn_settings.setText(QCoreApplication.translate("MainWindow", u"Cài đặt", None))
        
        self.label_credits.setText(QCoreApplication.translate("MainWindow", u"Designed by You", None))
